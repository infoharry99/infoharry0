...
import { Code2, Cpu, Briefcase, ShieldCheck, MessageSquare, Headphones, CheckCircle2 } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight">
            Why Clients <span className="text-blue-400">Choose Me</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {WHY_WORK_WITH_ME.map((card, idx) => {
            ...
            return (
              <div
                key={idx}
                className="glass-card p-6 rounded-2xl bg-slate-900/60 border border-slate-800/80 hover:border-blue-500/30 transition-all group"
              >
        ...
        <div className="p-8 sm:p-10 rounded-3xl bg-gradient-to-r from-blue-900/40 via-indigo-900/30 to-slate-900 border border-blue-500/30 text-center relative overflow-hidden shadow-2xl">
          <div className="absolute -top-10 -right-10 w-40 h-40 bg-blue-500/10 rounded-full blur-3xl pointer-events-none" />
          <h3 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight mb-2">
            "I don't just write code. I build software that solves real business problems."
          </h3>
          <p className="text-xs sm:text-sm text-blue-200/80 font-mono mt-2">
